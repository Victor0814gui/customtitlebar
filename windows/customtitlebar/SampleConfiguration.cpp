...
#include "pch.h"
#include <winrt/customtitlebar.h>
#include "App.h"
...
using namespace customtitlebar;
...
{
    Scenario{ L"Custom colors", xaml_typename<customtitlebar::Scenario1_Colors>() },
    Scenario{ L"Custom drawing", xaml_typename<customtitlebar::Scenario2_Extend>() },
});
